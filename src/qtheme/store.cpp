...
namespace qtheme
{
	...
	{
		return {
			QStringLiteral("palette/window"),	 QStringLiteral("palette/windowText"), QStringLiteral("palette/base"),
			QStringLiteral("palette/text"),		 QStringLiteral("palette/button"),	   QStringLiteral("palette/buttonText"),
			QStringLiteral("palette/highlight"), QStringLiteral("palette/accent"),	   QStringLiteral("button/bg"),
			QStringLiteral("button/fg"),		 QStringLiteral("button/border"),	   QStringLiteral("edit/bg"),
			QStringLiteral("edit/border"),		 QStringLiteral("check/bg"),		   QStringLiteral("tab/bg"),
			QStringLiteral("scroll/handle"),
		};
	}
