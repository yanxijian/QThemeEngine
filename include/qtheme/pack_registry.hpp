#ifndef __QTHEME_ENGINE_PACK_REGISTRY_H__
#define __QTHEME_ENGINE_PACK_REGISTRY_H__
...
namespace qtheme
{
	...
	private:
		...
		[[nodiscard]] bool materializeRecursive(const QString& id, ThemeStore* out, int depth, Error* err) const;

		QHash<QString, PackData> m_packs;
	};
} // namespace qtheme

#endif // __QTHEME_ENGINE_PACK_REGISTRY_H__
