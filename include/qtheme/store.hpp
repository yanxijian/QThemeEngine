...
namespace qtheme
{
	...
	public:
		...
		[[nodiscard]] ColorValue color(const QString& group, const QString& role, const QColor& def = QColor()) const;
		[[nodiscard]] int metric(const QString& group, const QString& role, int def = 0, bool* ok = nullptr) const;
