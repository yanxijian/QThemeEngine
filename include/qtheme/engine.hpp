...
namespace qtheme
{
	...
	public:
		...
		[[nodiscard]] bool accentFollowsSystem() const
		{
			return m_accentFollowSystem;
		}
		...
		[[nodiscard]] bool followOsHighContrast() const
		{
			return m_followOsHighContrast;
		}
		...
		[[nodiscard]] QStringList packSearchPaths() const
		{
			return m_packSearchPaths;
		}
		...
		[[nodiscard]] bool autoSavePreferences() const
		{
			return m_autoSavePreferences;
		}

		[[nodiscard]] ThemeStore* store() const
		{
			return m_store.get();
		}
		[[nodiscard]] QThemeStyle* style() const
		{
			return m_style;
		}
