...
控件清单：[docs/zh/qt-widgets-inventory.md](docs/zh/qt-widgets-inventory.md) · 格式 / Token：[docs/zh/theme-engine-spec.md](docs/zh/theme-engine-spec.md) · CI：[docs/zh/ci.md](docs/zh/ci.md)  
English：[docs/en/architecture.md](docs/en/architecture.md) · [docs/en/dev-plan.md](docs/en/dev-plan.md) · [docs/en/ci.md](docs/en/ci.md)
